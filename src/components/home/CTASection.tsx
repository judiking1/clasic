...
export default function CTASection() {
  ...
  return (
    <section ref={sectionRef} className="relative z-30 overflow-hidden section-unified">
      {/* Dark background with animated scale */}
      <motion.div className="absolute inset-0" style={{ scale: bgScale }}>
        {/* Gradient mesh (subtle glow, no solid bg) */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_20%_50%,rgba(184,149,106,0.12)_0%,transparent_50%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_80%_30%,rgba(184,149,106,0.08)_0%,transparent_50%)]" />
      </motion.div>
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-32 sm:px-6 sm:py-40 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <span className="glass-premium inline-flex items-center gap-2 rounded-full px-5 py-2">
          ...
          >
            ...
            >
              <span className="flex h-16 w-16 items-center justify-center rounded-full glass-accent transition-all duration-500 group-hover:border-accent/50 group-hover:bg-accent/20 group-hover:scale-110">
