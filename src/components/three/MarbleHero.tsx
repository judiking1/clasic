...
export default function MarbleHero() {
  return (
    <div className="relative h-full w-full cursor-grab active:cursor-grabbing">
      ...
      {/* Interaction hint */}
      <div className="absolute bottom-2 left-1/2 -translate-x-1/2 flex items-center gap-2 rounded-full border border-white/10 bg-white/3 px-3 py-1.5 backdrop-blur-sm sm:bottom-4 sm:px-4 sm:py-2">
