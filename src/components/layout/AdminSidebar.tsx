...
export default function AdminSidebar({ onCloseMobile }: AdminSidebarProps) {
  ...
  return (
    <aside className="flex h-full w-64 flex-col bg-gray-900 text-white">
      {/* Logo */}
      <div className="flex h-14 items-center justify-between border-b border-white/10 px-5 lg:h-16">
      ...
      <div className="border-t border-white/10 p-4 space-y-2">
        <Link
          href="/"
          target="_blank"
          className="flex items-center justify-center gap-2 rounded-lg px-3 py-2 text-xs text-white/50 hover:bg-white/5 hover:text-white/70 transition"
        >
